 ...
 */
async function removeWorker(file: string, search: ArgOrFunc, context: Context={}, one: boolean=false){
 ...
 */
async function remove(cpath: string, arg: ArgOrFunc, context: Context={}, one: boolean=false){
